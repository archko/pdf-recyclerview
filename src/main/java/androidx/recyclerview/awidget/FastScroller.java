 ...
 */
@VisibleForTesting
class FastScroller extends ARecyclerView.ItemDecoration implements ARecyclerView.OnItemTouchListener {
    ...
    private final ARecyclerView.OnScrollListener
            mOnScrollListener = new ARecyclerView.OnScrollListener() {
        @Override
        public void onScrolled(ARecyclerView recyclerView, int dx, int dy) {
            updateScrollPosition(recyclerView.computeHorizontalScrollOffset(),
                    recyclerView.computeVerticalScrollOffset());
        }
    };

    FastScroller(ARecyclerView recyclerView, StateListDrawable verticalThumbDrawable,
    ...
    @Override
    public void onDrawOver(Canvas canvas, ARecyclerView parent, ARecyclerView.State state) {
    ...
    @Override
    public void onTouchEvent(@NonNull ARecyclerView recyclerView, @NonNull MotionEvent me) {
        if (mState == STATE_HIDDEN) {
            return;
        }
