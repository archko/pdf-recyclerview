 ...
 * <p>
 * It wraps a ARecyclerView and adds ability to hide some children. There are two sets of methods
 ...
 * <p>
 * When ARecyclerView needs direct access to the view group children, it can call unfiltered
...
class ChildHelper {
    ...
    /**
     * Removes the provided View from underlying ARecyclerView.
     *
    ...
    /**
     * Removes the view at the provided index from ARecyclerView.
     *
     * @param index Index of the child from the regular perspective (excluding hidden views).
     *              ChildHelper offsets this index to actual ViewGroup index.
     */
    ...
    View findHiddenNonRemovedView(int position) {
        ...
        for (int i = 0; i < count; i++) {
            ...
            ARecyclerView.ViewHolder holder = mCallback.getChildViewHolder(view);
    ...
    interface Callback {
        ...
        ARecyclerView.ViewHolder getChildViewHolder(View view);
