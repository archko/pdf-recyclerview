 ...
 * decorations.
 *
 * @see #createHorizontalHelper(ARecyclerView.LayoutManager)
 * @see #createVerticalHelper(ARecyclerView.LayoutManager)
 */
public abstract class OrientationHelper {

    private static final int INVALID_SIZE = Integer.MIN_VALUE;

    protected final ARecyclerView.LayoutManager mLayoutManager;
    ...
    private OrientationHelper(ARecyclerView.LayoutManager layoutManager) {
        mLayoutManager = layoutManager;
    }

    /**
     * Returns the {@link ARecyclerView.LayoutManager LayoutManager} that
     * is associated with this OrientationHelper.
     */
    public ARecyclerView.LayoutManager getLayoutManager() {
     ...
     * {@link ARecyclerView.LayoutManager#onLayoutChildren(ARecyclerView.Recycler,
     * ARecyclerView.State)} method.
     *
     ...
     * its position
     * @see ARecyclerView.LayoutManager#getTransformedBoundingBox(View, boolean, Rect)
     */
     ...
     * @see ARecyclerView.LayoutManager#getWidthMode()
     * @see ARecyclerView.LayoutManager#getHeightMode()
     */
    ...
    public static OrientationHelper createOrientationHelper(
            ARecyclerView.LayoutManager layoutManager, @ARecyclerView.Orientation int orientation) {
        switch (orientation) {
            case HORIZONTAL:
    ...
    public static OrientationHelper createHorizontalHelper(
            ARecyclerView.LayoutManager layoutManager) {
     ...
     * @return A new OrientationHelper
     */
    public static OrientationHelper createVerticalHelper(ARecyclerView.LayoutManager layoutManager) {
        return new OrientationHelper(layoutManager) {
            @Override
            public int getEndAfterPadding() {
