 ...
 * {@link ARecyclerView.ViewHolder#itemView} and {@link ItemTouchUIUtil} makes necessary changes
...
public interface ItemTouchUIUtil {
     ...
     * ARecyclerView, ARecyclerView.ViewHolder, float, float, int, boolean)}
     */
    void onDraw(Canvas c, ARecyclerView recyclerView, View view,
     ...
     * ARecyclerView, ARecyclerView.ViewHolder, float, float, int, boolean)}
     */
    void onDrawOver(Canvas c, ARecyclerView recyclerView, View view,
                    float dX, float dY, int actionState, boolean isCurrentlyActive);

    /**
     * The default implementation for {@link ItemTouchHelper.Callback#clearView(ARecyclerView,
