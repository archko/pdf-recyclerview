...
package androidx.recyclerview.awidget;
 ...
 *     from the parent ARecyclerView, either unmodified if no rebinding is required or modified
 ...
 * </ul>
 *
 * <h3>Positions in ARecyclerView:</h3>
 * <p>
 * ARecyclerView introduces an additional level of abstraction between the {@link Adapter} and
 ...
 * <p>
 * For this reason, there are two types of <code>position</code> related methods in ARecyclerView:
 * <ul>
 ...
 * To display updatable data in a ARecyclerView, your adapter needs to signal inserts, moves, and
 * deletions to ARecyclerView. You can build this yourself by manually calling
 * {@code adapter.notify*} methods when content changes, or you can use one of the easier solutions
 * ARecyclerView provides:
 * <p>
 * <h4>List diffing with DiffUtil</h4>
 * If your ARecyclerView is displaying a list that is re-fetched from scratch for each update (e.g.
 ...
 * which can be passed to ARecyclerView to trigger minimal animations and updates to keep your UI
 ...
 * <p>
 * There are three primary ways to do this for ARecyclerView. We recommend you start with
 ...
 * If your ARecyclerView receives updates incrementally, e.g. item X is inserted, or item Y is
 * removed, you can use {@link SortedList} to manage your list. You define how to order items,
 * and it will automatically trigger update signals that ARecyclerView can use. SortedList works
 ...
 */
public class ARecyclerView extends ViewGroup implements ScrollingView,
        NestedScrollingChild2, NestedScrollingChild3 {

    static final String TAG = "ARecyclerView";
     ...
     * this value might be garbage. To save LayoutManagers from it, ARecyclerView sets the size to
     ...
     * that the ARecyclerView should use the standard touch slop for smooth,
    ...
    /**
     * Constant for use with {@link #setScrollingTouchSlop(int)}. Indicates
     * that the ARecyclerView should use the standard touch slop for scrolling
    ...
    /**
     * ARecyclerView is calculating a scroll.
     * If there are too many of these in Systrace, some Views inside ARecyclerView might be causing
     ...
     * If this shows up too many times in Systrace, make sure the children of ARecyclerView do not
     * update themselves directly. This will cause a full re-layout but when it happens via the
     * Adapter notifyItemChanged, ARecyclerView can avoid full layout calculation.
     */
    ...
    /**
     * ARecyclerView is doing a layout for partial adapter updates (we know what has changed)
    ...
    /**
     * ARecyclerView is rebinding a View.
    ...
    /**
     * ARecyclerView is attempting to pre-populate off screen views.
     */
    static final String TRACE_PREFETCH_TAG = "RV Prefetch";

    /**
     * ARecyclerView is attempting to pre-populate off screen itemviews within an off screen
     * ARecyclerView.
     */
    static final String TRACE_NESTED_PREFETCH_TAG = "RV Nested Prefetch";

    /**
     * ARecyclerView is creating a new View.
    ...
    /**
     * Handles abstraction between LayoutManager children and ARecyclerView children
     */
     ...
     * {@link LayoutManager#onItemsChanged(ARecyclerView)} should be called during the subsequent
     * measure/layout.
     *
     * @see #processDataSetCompletelyChanged(boolean)
     */
    ...
    /**
     * The ARecyclerView is not currently scrolling.
     *
     * @see #getScrollState()
     */
    ...
    /**
     * The ARecyclerView is currently being dragged by outside input such as user touch input.
     *
     * @see #getScrollState()
     */
    ...
    /**
     * The ARecyclerView is currently animating to a final position while not under
     * outside control.
     *
     * @see #getScrollState()
     */
    ...
    public ARecyclerView(@NonNull Context context, @Nullable AttributeSet attrs) {
        this(context, attrs, R.attr.arecyclerViewStyle);
    }

    public ARecyclerView(@NonNull Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
        ...
        TypedArray a = context.obtainStyledAttributes(attrs, R.styleable.ARecyclerView,
                defStyleAttr, 0);

        ViewCompat.saveAttributeDataForStyleable(this, context, R.styleable.ARecyclerView,
                attrs, a, defStyleAttr, 0);
        String layoutManagerName = a.getString(R.styleable.ARecyclerView_layoutManager);
        int descendantFocusability = a.getInt(
                R.styleable.ARecyclerView_android_descendantFocusability, -1);
        if (descendantFocusability == -1) {
            setDescendantFocusability(ViewGroup.FOCUS_AFTER_DESCENDANTS);
        }
        mClipToPadding = a.getBoolean(R.styleable.ARecyclerView_android_clipToPadding, true);
        mEnableFastScroller = a.getBoolean(R.styleable.ARecyclerView_fastScrollEnabled, false);
        if (mEnableFastScroller) {
            StateListDrawable verticalThumbDrawable = (StateListDrawable) a
                    .getDrawable(R.styleable.ARecyclerView_fastScrollVerticalThumbDrawable);
            Drawable verticalTrackDrawable = a
                    .getDrawable(R.styleable.ARecyclerView_fastScrollVerticalTrackDrawable);
            StateListDrawable horizontalThumbDrawable = (StateListDrawable) a
                    .getDrawable(R.styleable.ARecyclerView_fastScrollHorizontalThumbDrawable);
            Drawable horizontalTrackDrawable = a
                    .getDrawable(R.styleable.ARecyclerView_fastScrollHorizontalTrackDrawable);
    ...
    /**
     * Returns the accessibility delegate compatibility implementation used by the ARecyclerView.
     *
     * @return An instance of AccessibilityDelegateCompat used by ARecyclerView
     */
    @Nullable
    ...
    /**
     * Sets the accessibility delegate compatibility implementation used by ARecyclerView.
     *
     * @param accessibilityDelegate The accessibility delegate to be used by ARecyclerView.
     */
    ...
    public CharSequence getAccessibilityClassName() {
        return "androidx.recyclerview.widget.ARecyclerView";
    }
    ...
    private String getFullClassName(Context context, String className) {
        ...
        return ARecyclerView.class.getPackage().getName() + '.' + className;
    }
    ...
    private void initChildrenHelper() {
        mChildHelper = new ChildHelper(new ChildHelper.Callback() {
            ...
            public int getChildCount() {
                return ARecyclerView.this.getChildCount();
            }
            ...
            public void addView(View child, int index) {
                ...
                ARecyclerView.this.addView(child, index);
                if (VERBOSE_TRACING) {
            ...
            public int indexOfChild(View view) {
                return ARecyclerView.this.indexOfChild(view);
            }

            @Override
            public void removeViewAt(int index) {
                final View child = ARecyclerView.this.getChildAt(index);
                if (child != null) {
                ...
                ARecyclerView.this.removeViewAt(index);
                if (VERBOSE_TRACING) {
                    TraceCompat.endSection();
                }
            }
            ...
            public View getChildAt(int offset) {
                return ARecyclerView.this.getChildAt(offset);
            }
            ...
            public void removeAllViews() {
                ...
                ARecyclerView.this.removeAllViews();
            }
            ...
            public void attachViewToParent(View child, int index,
                ...
                ARecyclerView.this.attachViewToParent(child, index, layoutParams);
            }
            ...
            public void detachViewFromParent(int offset) {
                ...
                ARecyclerView.this.detachViewFromParent(offset);
            }
            ...
            public void onEnteredHiddenState(View child) {
                final ViewHolder vh = getChildViewHolderInt(child);
                if (vh != null) {
                    vh.onEnteredHiddenState(ARecyclerView.this);
                }
            }
            ...
            public void onLeftHiddenState(View child) {
                final ViewHolder vh = getChildViewHolderInt(child);
                if (vh != null) {
                    vh.onLeftHiddenState(ARecyclerView.this);
                }
            }
        });
    }
            ...
            void dispatchUpdate(AdapterHelper.UpdateOp op) {
                switch (op.cmd) {
                    case AdapterHelper.UpdateOp.ADD:
                        mLayout.onItemsAdded(ARecyclerView.this, op.positionStart, op.itemCount);
                        break;
                    case AdapterHelper.UpdateOp.REMOVE:
                        mLayout.onItemsRemoved(ARecyclerView.this, op.positionStart, op.itemCount);
                        break;
                    case AdapterHelper.UpdateOp.UPDATE:
                        mLayout.onItemsUpdated(ARecyclerView.this, op.positionStart, op.itemCount,
                                op.payload);
                        break;
                    case AdapterHelper.UpdateOp.MOVE:
                        mLayout.onItemsMoved(ARecyclerView.this, op.positionStart, op.itemCount, 1);
                        break;
                }
            }
    ...
    /**
     * ARecyclerView can perform several optimizations if it can know in advance that ARecyclerView's
     * size is not affected by the adapter contents. ARecyclerView can still change its size based
     * on other factors (e.g. its parent's size) but this size calculation cannot depend on the
     * size of its children or contents of its adapter (except the number of items in the adapter).
     * <p>
     * If your use of ARecyclerView falls into this category, set this to {@code true}. It will allow
     * ARecyclerView to avoid invalidating the whole layout when its adapter contents change.
     *
     * @param hasFixedSize true if adapter changes cannot affect the size of the ARecyclerView.
     */
     ...
     * the size of the ARecyclerView itself.
     */
    ...
    /**
     * Returns whether this ARecyclerView will clip its children to its padding, and resize (but
     * not clip) any EdgeEffect to the padded region, if padding is present.
     * <p>
     * By default, children are clipped to the padding of their parent
     * ARecyclerView. This clipping behavior is only enabled if padding is non-zero.
     *
     * @return true if this ARecyclerView clips children to its padding and resizes (but doesn't
     ...
     *
     * Set up the ARecyclerView's scrolling motion threshold based on common usages.
     ...
     *                     the intended usage of this ARecyclerView
     */
     ...
     * @param removeAndRecycleExistingViews If set to true, ARecyclerView will recycle all existing
     ...
     *
     * <p>This listener will be called when a LayoutManager or the ARecyclerView decides
     ...
     * Register a listener that will be notified whenever a child view is recycled.
     *
     * <p>The listeners will be called when a LayoutManager or the ARecyclerView decides
    ...
    /**
     * <p>Return the offset of the ARecyclerView's text baseline from the its top
     * boundary. If the LayoutManager of this ARecyclerView does not support baseline alignment,
     * this method returns -1.</p>
     *
     * @return the offset of the baseline within the ARecyclerView's bounds or -1
    ...
    /**
     * Set the {@link LayoutManager} that this ARecyclerView will use.
     *
     * <p>In contrast to other adapter-backed views such as {@link android.widget.ListView}
     * or {@link android.widget.GridView}, ARecyclerView allows client code to provide custom
     * layout arrangements for child views. These arrangements are controlled by the
     * {@link LayoutManager}. A LayoutManager must be provided for ARecyclerView to function.</p>
     *
        ...
        if (layout != null) {
            if (layout.mRecyclerView != null) {
                throw new IllegalArgumentException("LayoutManager " + layout
                        + " is already attached to a ARecyclerView:"
    ...
    /**
     * Set a {@link OnFlingListener} for this {@link ARecyclerView}.
     * <p>
    ...
    /**
     * Get the current {@link OnFlingListener} from this {@link ARecyclerView}.
     *
     ...
     * part of the child list of the ARecyclerView, but they are invisible to the LayoutManager
     ...
     * @see #addAnimatingView(ARecyclerView.ViewHolder)
     */
     ...
     * layout policy for this ARecyclerView.
     *
    ...
    /**
     * Retrieve this ARecyclerView's {@link RecycledViewPool}. This method will never return null;
    ...
    /**
     * Return the current scrolling state of the ARecyclerView.
     *
    ...
    /**
     * Add an {@link ItemDecoration} to this ARecyclerView. Item decorations can
    ...
    /**
     * Returns an {@link ItemDecoration} previously added to this ARecyclerView.
     *
    ...
    /**
     * Returns the number of {@link ItemDecoration} currently added to this ARecyclerView.
     *
     * @return number of ItemDecorations currently added added to this ARecyclerView.
     */
    ...
    /**
     * Remove an {@link ItemDecoration} from this ARecyclerView.
     *
     ...
     *
     * ARecyclerView does not implement scrolling logic, rather forwards the call to
     * {@link ARecyclerView.LayoutManager#scrollToPosition(int)}
     *
     * @param position Scroll to this adapter position
     * @see ARecyclerView.LayoutManager#scrollToPosition(int)
     */
     ...
     * {@link LayoutManager#smoothScrollToPosition(ARecyclerView, State, int)} and create a
     * {@link SmoothScroller}.
     * <p>
     * {@link LayoutManager} is responsible for creating the actual scroll action. If you want to
     * provide a custom smooth scroll logic, override
     * {@link LayoutManager#smoothScrollToPosition(ARecyclerView, State, int)} in your
     * LayoutManager.
     *
     * @param position The adapter position to scroll to
     * @see LayoutManager#smoothScrollToPosition(ARecyclerView, State, int)
     */
    ...
    public void scrollTo(int x, int y) {
        Log.w(TAG, "ARecyclerView does not support scrolling to an absolute position. "
    ...
    /**
     * Same as {@link ARecyclerView#scrollBy(int, int)}, but also participates in nested scrolling.
     *
    ...
    /**
     * Similar to {@link ARecyclerView#scrollByInternal(int, int, MotionEvent, int)}, but fully
     ...
     * {@link ARecyclerView.LayoutManager#computeHorizontalScrollOffset(ARecyclerView.State)} in your
     * LayoutManager. </p>
     *
     * @return The horizontal offset of the scrollbar's thumb
     * @see ARecyclerView.LayoutManager#computeHorizontalScrollOffset
     * (ARecyclerView.State)
     */
    @Override
     ...
     *
     * <p>If you want to support scroll bars, override
     * {@link ARecyclerView.LayoutManager#computeHorizontalScrollExtent(ARecyclerView.State)} in your
     * LayoutManager.</p>
     *
     * @return The horizontal extent of the scrollbar's thumb
     * @see ARecyclerView.LayoutManager#computeHorizontalScrollExtent(ARecyclerView.State)
     */
    @Override
     ...
     *
     * <p>If you want to support scroll bars, override
     * {@link ARecyclerView.LayoutManager#computeHorizontalScrollRange(ARecyclerView.State)} in your
     * LayoutManager.</p>
     *
     * @return The total horizontal range represented by the vertical scrollbar
     * @see ARecyclerView.LayoutManager#computeHorizontalScrollRange(ARecyclerView.State)
     */
    @Override
     ...
     *
     * <p>If you want to support scroll bars, override
     * {@link ARecyclerView.LayoutManager#computeVerticalScrollOffset(ARecyclerView.State)} in your
     * LayoutManager.</p>
     *
     * @return The vertical offset of the scrollbar's thumb
     * @see ARecyclerView.LayoutManager#computeVerticalScrollOffset
     * (ARecyclerView.State)
     */
    @Override
     ...
     *
     * <p>If you want to support scroll bars, override
     * {@link ARecyclerView.LayoutManager#computeVerticalScrollExtent(ARecyclerView.State)} in your
     * LayoutManager.</p>
     *
     * @return The vertical extent of the scrollbar's thumb
     * @see ARecyclerView.LayoutManager#computeVerticalScrollExtent(ARecyclerView.State)
     */
    @Override
     ...
     *
     * <p>If you want to support scroll bars, override
     * {@link ARecyclerView.LayoutManager#computeVerticalScrollRange(ARecyclerView.State)} in your
     * LayoutManager.</p>
     *
     * @return The total vertical range represented by the vertical scrollbar
     * @see ARecyclerView.LayoutManager#computeVerticalScrollRange(ARecyclerView.State)
     */
    @Override
     ...
     * {@link ARecyclerView#requestLayout()}.  Doing so enables {@link ARecyclerView} to avoid
     ...
     * child View to cause a call to {@link ARecyclerView#requestLayout()}.
     *
     ...
     * {@link ARecyclerView#requestLayout()}.
     * <p>
     * A call to this method must always be accompanied by a call to
     * {@link #startInterceptRequestLayout()} that precedes the code that may trigger a child
     * View to cause a call to {@link ARecyclerView#requestLayout()}.
     *
    ...
    /**
     * Tells this ARecyclerView to suppress all layout and scroll calls until layout
     ...
     * child views are not updated when ARecyclerView is frozen, {@link #smoothScrollBy(int, int)},
     * {@link #scrollBy(int, int)}, {@link #scrollToPosition(int)} and
     * {@link #smoothScrollToPosition(int)} are dropped; TouchEvents and GenericMotionEvents are
     * dropped; {@link LayoutManager#onFocusSearchFailed(View, int, Recycler, State)} will not be
     * called.
    ...
    public void setLayoutTransition(LayoutTransition transition) {
        ...
        if (transition == null) {
            ...
            throw new IllegalArgumentException("Providing a LayoutTransition into ARecyclerView is "
                    + "not supported. Please use setItemAnimator() instead for animating changes "
                    + "to the items in this ARecyclerView");
        }
    }
     ...
     *                     {@code null}, ARecyclerView will use an internal default interpolator.
     */
    ...
    /**
     * Smooth scrolls the ARecyclerView by a given distance.
     *
     ...
     *                     ARecyclerView will use an internal default interpolator.
     ...
     * @param size       The width or height of the ARecyclerView, depending on the edge that the
     *                   EdgeEffect is on.
    ...
    /**
     * Returns the maximum fling velocity used by this ARecyclerView.
     *
     * @return The maximum fling velocity used by this ARecyclerView.
     */
    ...
    /**
     * Set a {@link EdgeEffectFactory} for this {@link ARecyclerView}.
     * <p>
     ...
     * {@link EdgeEffectFactory#createEdgeEffect(ARecyclerView, int)}
     *
    ...
    /**
     * Since ARecyclerView is a collection ViewGroup that includes virtual children (items that are
     ...
     * <p>
     * It first does a focus search within the ARecyclerView. If this search finds a View that is in
     * the focus direction with respect to the currently focused View, ARecyclerView returns that
     ...
     * ARecyclerView will call parent to handle the focus search like a regular ViewGroup.
     * <p>
     ...
     * ARecyclerView converts the focus direction to an absolute direction and makes a preliminary
     ...
     * focus search with the original (relative) direction. This allows ARecyclerView to provide
     * better candidates to the focus search while still allowing the view system to take focus from
     * the ARecyclerView and give it to a more suitable child if such child exists.
     *
    ...
    /**
     * Checks if the new focus candidate is a good enough candidate such that ARecyclerView will
     ...
     * and is not the ARecyclerView itself.
     * When this method returns false, ARecyclerView will let the parent make the decision so the
    ...
    /**
     * Requests that the given child of the ARecyclerView be positioned onto the screen. This method
     ...
     *
     * @param child   The child view of this ARecyclerView that wants to come onto the screen.
    ...
    /**
     * Returns true if ARecyclerView is attached to window.
     */
    @Override
    ...
    /**
     * Checks if ARecyclerView is in the middle of a layout or scroll and throws an
    ...
    void assertInLayoutOrScroll(String message) {
        if (!isComputingLayout()) {
            if (message == null) {
                throw new IllegalStateException("Cannot call this method unless ARecyclerView is "
    ...
    void assertNotInLayoutOrScroll(String message) {
        if (isComputingLayout()) {
            if (message == null) {
                throw new IllegalStateException("Cannot call this method while ARecyclerView is "
                        + "computing a layout or scrolling" + exceptionLabel());
            }
        ...
        if (mDispatchScrollCounter > 0) {
            Log.w(TAG, "Cannot call this method in a scroll callback. Scroll callbacks might"
                            ...
                            + "ARecyclerView data. Any method call that might change the structure"
                            + "of the ARecyclerView or the adapter contents should be postponed to"
                            + "the next frame.",
     ...
     * returns true from
     * {@link OnItemTouchListener#onInterceptTouchEvent(ARecyclerView, MotionEvent)} its
     * {@link OnItemTouchListener#onTouchEvent(ARecyclerView, MotionEvent)} method will be called
     ...
     *
     * <p>Calls {@link OnItemTouchListener#onInterceptTouchEvent(ARecyclerView, MotionEvent)} on each
     ...
     * OnItemTouchListener to be called for future {@link ARecyclerView#onTouchEvent(MotionEvent)}
    ...
    protected void onMeasure(int widthSpec, int heightSpec) {
        ...
        if (mLayout.isAutoMeasureEnabled()) {
            ...
            // if ARecyclerView has non-exact width and height and if there is at least one child
     ...
     * where this ARecyclerView is otherwise lacking better information.
     */
     ...
     * to the items in this ARecyclerView. By default, ARecyclerView instantiates and
     * uses an instance of {@link DefaultItemAnimator}. Whether item animations are
     * enabled for the ARecyclerView depends on the ItemAnimator and whether
     * the LayoutManager {@link LayoutManager#supportsPredictiveItemAnimations()
     * supports item animations}.
     *
     * @param animator The ItemAnimator being set. If null, no animations will occur
     *                 when changes occur to the items in this ARecyclerView.
     */
    ...
    /**
     * Returns whether ARecyclerView is currently computing a layout.
     * <p>
     * If this method returns true, it means that ARecyclerView is in a lockdown state and any
     * attempt to update adapter contents will result in an exception because adapter contents
     * cannot be changed while ARecyclerView is trying to compute the layout.
     * <p>
     * It is very unlikely that your code will be running during this state as it is
     * called by the framework when a layout traversal happens or ARecyclerView starts to scroll
     ...
     * similar mechanism.
     *
     * @return <code>true</code> if ARecyclerView is currently computing a layout, <code>false</code>
     * otherwise
     */
     ...
     * accessibility request arrives while ARecyclerView does not have a stable state which is very
    ...
    /**
     * Gets the current ItemAnimator for this ARecyclerView. A null return value
     * indicates that there is no animator and that item changes will happen without
     * any animations. By default, ARecyclerView instantiates and
    ...
    public void draw(Canvas c) {
        ...
        // Invalidate ARecyclerView to re-draw decorators. This is still efficient because children's
    ...
    protected ViewGroup.LayoutParams generateDefaultLayoutParams() {
        if (mLayout == null) {
            throw new IllegalStateException("ARecyclerView has no LayoutManager" + exceptionLabel());
        }
    ...
    /**
     * Returns true if ARecyclerView is currently running some animations.
     * <p>
     ...
     *                             {@link LayoutManager#onItemsChanged(ARecyclerView)} during
     *                             measure/layout.
     */
    ...
    /**
     * Invalidates all ItemDecorations. If ARecyclerView has item decorations, calling this method
    ...
    /**
     * Returns true if the ARecyclerView should attempt to preserve currently focused Adapter Item's
     * focus even if the View representing the Item is replaced during a layout calculation.
     * <p>
     * By default, this value is {@code true}.
     *
     * @return True if the ARecyclerView will try to preserve focused Item after a layout if it loses
     * focus.
    ...
    /**
     * Set whether the ARecyclerView should try to keep the same Item focused after a layout
     * calculation or not.
     * <p>
     ...
     * with another view due to type change or animation. In these cases, ARecyclerView can request
     * focus on the new view automatically.
     *
     * @param preserveFocusAfterLayout Whether ARecyclerView should preserve focused Item during a
     ...
     *
     * @param child Child of this ARecyclerView to query for its ViewHolder
     ...
     * also a direct child of the ARecyclerView. This returned view can be used to get the
     * ViewHolder by calling {@link #getChildViewHolder(View)}.
     *
     * @param view The view that is a descendant of the ARecyclerView.
     * @return The direct child of the ARecyclerView which contains the given view or null if the
     * provided view is not a descendant of this ARecyclerView.
     ...
     * descendant of this ARecyclerView.
     */
    @Nullable
     ...
     * layout pass.
     * <p>
     * This method checks only the children of ARecyclerView. If the item at the given
     ...
     * of a ViewHolder. If the {@link Adapter} that is assigned to the ARecyclerView is an adapter
    ...
    /**
     * Return the ViewHolder for the item with the given id. The ARecyclerView must
     * use an Adapter with {@link Adapter#setHasStableIds(boolean) stableIds} to
     * return a non-null value.
     * <p>
     * This method checks only the children of ARecyclerView. If the item with the given
    ...
    /**
     * Called when an item view is attached to this ARecyclerView.
     *
     * <p>Subclasses of ARecyclerView may want to perform extra bookkeeping or modifications
     ...
     * changes.</p>
     *
     * @param child Child view that is now attached to this ARecyclerView and its associated window
     */
    public void onChildAttachedToWindow(@NonNull View child) {
    }

    /**
     * Called when an item view is detached from this ARecyclerView.
     *
     * <p>Subclasses of ARecyclerView may want to perform extra bookkeeping or modifications
     ...
     *
     * @param child Child view that is now detached from this ARecyclerView and its associated window
     */
    ...
    /**
     * Called when the scroll position of this ARecyclerView changes. Subclasses should use
     ...
     * scroll coordinates. Since ARecyclerView cannot compute the absolute scroll position from
    ...
    void dispatchOnScrolled(int hresult, int vresult) {
        ...
        // Pass the real deltas to onScrolled, the ARecyclerView-specific method.
    ...
    /**
     * Called when the scroll state of this ARecyclerView changes. Subclasses should use this
    ...
    void dispatchOnScrollStateChanged(int state) {
        ...
        // a consistent state before the ARecyclerView subclass responds.
        if (mLayout != null) {
            mLayout.onScrollStateChanged(state);
        }

        // Let the ARecyclerView subclass handle this event next; any LayoutManager property
     ...
     * <p>
     * This method returns true if ARecyclerView has not yet calculated the first layout after it is
    ...
    class ViewFlinger implements Runnable {
        ...
        public void run() {
            ...
            if (scroller.computeScrollOffset()) {
                ...
                if (!smoothScrollerPending && doneScrolling) {
                    ...
                    postOnAnimation();
                    if (mGapWorker != null) {
                        mGapWorker.postFromTraversal(ARecyclerView.this, consumedX, consumedY);
                    }
                }
            }
        ...
        private void internalPostOnAnimation() {
            ...
            ViewCompat.postOnAnimation(ARecyclerView.this, this);
        }
    ...
    private class RecyclerViewDataObserver extends AdapterDataObserver {
        ...
        void triggerUpdateProcessor() {
            if (POST_UPDATES_ON_ANIMATION && mHasFixedSize && mIsAttached) {
                ViewCompat.postOnAnimation(ARecyclerView.this, mUpdateChildViewsRunnable);
            } else {
     ...
     *
     * @see ARecyclerView#setEdgeEffectFactory(EdgeEffectFactory)
     */
    public static class EdgeEffectFactory {
         ...
         */
        protected @NonNull
        EdgeEffect createEdgeEffect(@NonNull ARecyclerView view,
    ...
    static class StretchEdgeEffectFactory extends EdgeEffectFactory {
        @NonNull
        @Override
        protected EdgeEffect createEdgeEffect(@NonNull ARecyclerView view, int direction) {
            return new EdgeEffect(view.getContext());
        }
    }
     ...
     * and use {@link ARecyclerView#setRecycledViewPool(RecycledViewPool)}.
     * <p>
     * ARecyclerView automatically creates a pool for itself if you don't provide one.
     */
    public static class RecycledViewPool {
         ...
         * ARecyclerView is removed from the view hierarchy and thrown away to be GCed, the
         ...
         * it will be decremented whenever a ARecyclerView is detached from the window.  This
         * could potentially be inaccurate in the unlikely event that someone is manually driving
         * a detached ARecyclerView by calling measure, layout, draw, etc.  However, the
         * implementation of {@link ARecyclerView#onDetachedFromWindow()} suggests this is not the
    ...
    /**
     * Utility method for finding an internal ARecyclerView, if present
     */
    @Nullable
    static ARecyclerView findNestedRecyclerView(@NonNull View view) {
        if (!(view instanceof ViewGroup)) {
            return null;
        }
        if (view instanceof ARecyclerView) {
            return (ARecyclerView) view;
        }
        final ViewGroup parent = (ViewGroup) view;
        final int count = parent.getChildCount();
        for (int i = 0; i < count; i++) {
            final View child = parent.getChildAt(i);
            final ARecyclerView descendant = findNestedRecyclerView(child);
            if (descendant != null) {
                return descendant;
            }
        }
    ...
    /**
     * Utility method for clearing holder's internal ARecyclerView, if present
     */
     ...
     *
     * <p>A "scrapped" view is a view that is still attached to its parent ARecyclerView but
    ...
    public final class Recycler {
        ...
        private boolean tryBindViewHolderByDeadline(@NonNull ViewHolder holder, int offsetPosition,
            ...
            holder.mOwnerRecyclerView = ARecyclerView.this;
         ...
         * and let the ARecyclerView handle caching. This is a helper method for LayoutManager who
        ...
        /**
         * ARecyclerView provides artificial position range (item count) in pre-layout state and
        ...
        ViewHolder tryGetViewHolderForPositionByDeadline(int position,
            ...
            if (holder == null) {
                ...
                if (holder == null) {
                    ...
                    holder = mAdapter.createViewHolder(ARecyclerView.this, type);
                    if (ALLOW_THREAD_GAP_WORK) {
                        // only bother finding nested RV if prefetching
                        ARecyclerView innerView = findNestedRecyclerView(holder.itemView);
                        if (innerView != null) {
         ...
         * case, adapter may choose to recycle it. From ARecyclerView's perspective, the view is
        ...
        void recycleViewHolderInternal(ViewHolder holder) {
            ...
            if (holder.isTmpDetached()) {
                throw new IllegalArgumentException("Tmp detached view should be removed "
                        + "from ARecyclerView before it can be recycled: " + holder
                        + exceptionLabel());
            }
         ...
         *
         * <p>"Scrap" views are still attached to their parent ARecyclerView but are eligible
        ...
        ViewHolder getScrapOrHiddenOrCachedHolderForPosition(int position, boolean dryRun) {
            ...
            if (!dryRun) {
                ...
                if (view != null) {
                    ...
                    if (layoutIndex == ARecyclerView.NO_POSITION) {
    ...
    public abstract static class ViewCacheExtension {
         ...
         * <p>
         * ARecyclerView will re-bind the returned View to the position if necessary.
         *
    ...
    public abstract static class Adapter<VH extends ViewHolder> {
        ...
        /**
         * Called when ARecyclerView needs a new {@link ViewHolder} of the given type to represent
         * an item.
         * <p>
        ...
        /**
         * Called by ARecyclerView to display the data at the specified position. This method should
         * update the contents of the {@link ViewHolder#itemView} to reflect the item at the given
         * position.
         * <p>
         * Note that unlike {@link android.widget.ListView}, ARecyclerView will not call this method
        ...
        /**
         * Called by ARecyclerView to display the data at the specified position. This method
         ...
         * {@link ARecyclerView#NO_POSITION} is returned.
         *
         ...
         * or {@link ARecyclerView#NO_POSITION} if the {@link ViewHolder} is not bound to an item
         ...
         * {@link ViewHolder} and initializes some private fields to be used by ARecyclerView.
         *
         ...
         * private fields to be used by ARecyclerView.
         *
         * Adapters that merge other adapters should use
         * {@link #bindViewHolder(ViewHolder, int)} when calling nested adapters so that
         * ARecyclerView can track which adapter bound the {@link ViewHolder} to return the correct
        ...
        public final void bindViewHolder(@NonNull VH holder, int position) {
            ...
            if (rootBind) {
                ...
                if (layoutParams instanceof ARecyclerView.LayoutParams) {
         ...
         * needs to be attached to its parent {@link ARecyclerView}. This can be because it has
         * fallen out of visibility or a set of cached views represented by views still
         * attached to the parent ARecyclerView. If an item view has large or expensive data
         * bound to it such as large bitmaps, this may be a good place to release those
         * resources.</p>
         * <p>
         * ARecyclerView calls this method right before clearing ViewHolder's internal data and
        ...
        /**
         * Called by the ARecyclerView if a ViewHolder created by this Adapter cannot be recycled
         ...
         * For this reason, ARecyclerView leaves the decision to the Adapter and uses the return
         * value of this method to decide whether the View should be recycled or not.
         * <p>
         * Note that when all animations are created by {@link ARecyclerView.ItemAnimator}, you
         * should never receive this callback because ARecyclerView keeps those Views as children
         ...
         * returns <code>true</code>, ARecyclerView <em>will ignore</em> the transient state of
         * the View and recycle it regardless. If this method returns <code>false</code>,
         * ARecyclerView will check the View's transient state again before giving a final decision.
         ...
         * {@link #onViewDetachedFromWindow(ARecyclerView.ViewHolder) onViewDetachedFromWindow}
         ...
         * {@link ARecyclerView.AdapterDataObserver#onChanged()
         * "something changed"} event if more specific data is not available.</p>
         *
         * <p>Components registering observers with an adapter are responsible for
         * {@link #unregisterAdapterDataObserver(ARecyclerView.AdapterDataObserver)
         * unregistering} those observers when finished.</p>
         *
         * @param observer Observer to register
         * @see #unregisterAdapterDataObserver(ARecyclerView.AdapterDataObserver)
         */
         ...
         * @see #registerAdapterDataObserver(ARecyclerView.AdapterDataObserver)
         */
        ...
        /**
         * Called by ARecyclerView when it starts observing this Adapter.
         * <p>
         * Keep in mind that same adapter may be observed by multiple RecyclerViews.
         *
         * @param recyclerView The ARecyclerView instance which started observing this adapter.
         * @see #onDetachedFromRecyclerView(ARecyclerView)
         */
        public void onAttachedToRecyclerView(@NonNull ARecyclerView recyclerView) {
        }

        /**
         * Called by ARecyclerView when it stops observing this Adapter.
         *
         * @param recyclerView The ARecyclerView instance which stopped observing this adapter.
         * @see #onAttachedToRecyclerView(ARecyclerView)
         */
        public void onDetachedFromRecyclerView(@NonNull ARecyclerView recyclerView) {
        }
         ...
         *
         * <p><code>ARecyclerView</code> will attempt to synthesize visible structural change events
         ...
         * <p>
         * By default, it is set to {@link StateRestorationPolicy#ALLOW} which means ARecyclerView
         * expects any set Adapter to be immediately capable of restoring the ARecyclerView's saved
         * scroll position.
         * <p>
         ...
         * Note that the former means your ARecyclerView will restore state as soon as Adapter has
         ...
         * <p>
         * ARecyclerView will still layout even when State restoration is disabled. The behavior of
        ...
        /**
         * Called by the ARecyclerView to decide whether the SavedState should be given to the
        ...
        public enum StateRestorationPolicy {
            /**
             * Adapter is ready to restore State immediately, ARecyclerView will provide the state
             * to the LayoutManager in the next layout pass.
             */
            ALLOW,
            /**
             * Adapter is ready to restore State when it has more than 0 items. ARecyclerView will
             * provide the state to the LayoutManager as soon as the Adapter has 1 or more items.
             */
            PREVENT_WHEN_EMPTY,
            /**
             * ARecyclerView will not restore the state for the Adapter until a call to
     ...
     * within a <code>ARecyclerView</code> as well as determining the policy for when to recycle
     * item views that are no longer visible to the user. By changing the <code>LayoutManager</code>
     * a <code>ARecyclerView</code> can be used to implement a standard vertically scrolling list,
     * a uniform grid, staggered grids, horizontally scrolling collections and more. Several stock
     * layout managers are provided for general use.
     * <p/>
     * If the LayoutManager specifies a default constructor or one with the signature
     * ({@link Context}, {@link AttributeSet}, {@code int}, {@code int}), ARecyclerView will
    ...
    public abstract static class LayoutManager {
        ...
        /**
         * The callback used for retrieving information about a ARecyclerView and its children in the
        ...
        private final ViewBoundsCheck.Callback mHorizontalBoundCheckCallback =
                new ViewBoundsCheck.Callback() {
                    ...
                    public int getChildStart(View view) {
                        final ARecyclerView.LayoutParams params = (ARecyclerView.LayoutParams)
        ...
        /**
         * These measure specs might be the measure specs that were passed into ARecyclerView's
         * onMeasure method OR fake measure specs created by the ARecyclerView.
         * For example, when a layout is run, ARecyclerView always sets these specs to be
         * EXACTLY because a LayoutManager cannot resize ARecyclerView during a layout pass.
         * <p>
         * Also, to be able to use the hint in unspecified measure specs, ARecyclerView checks the
        ...
        void setRecyclerView(ARecyclerView recyclerView) {
         ...
         *
         * @param widthSpec  The widthSpec that was passing into ARecyclerView's onMeasure
         * @param heightSpec The heightSpec that was passing into ARecyclerView's onMeasure
         */
         ...
         * measurement specs that were passed into {@link ARecyclerView#onMeasure(int, int)}. It is
         * only called if a LayoutManager returns <code>true</code> from
         * {@link #isAutoMeasureEnabled()} and it is called after the ARecyclerView calls
         * {@link LayoutManager#onLayoutChildren(Recycler, State)} in the execution of
         * {@link ARecyclerView#onMeasure(int, int)}.
         * <p>
         * This method must call {@link #setMeasuredDimension(int, int)}.
         * <p>
         * The default implementation adds the ARecyclerView's padding to the given bounding box
         * then caps the value to be within the given measurement specs.
         *
         * @param childrenBounds The bounding box of all children
         * @param wSpec          The widthMeasureSpec that was passed into the ARecyclerView.
         * @param hSpec          The heightMeasureSpec that was passed into the ARecyclerView.
        ...
        /**
         * Calls {@code ARecyclerView#requestLayout} on the underlying ARecyclerView
         */
        public void requestLayout() {
         ...
         * {@link ARecyclerView} or if it should be done by the LayoutManager's implementation of
         ...
         *                ARecyclerView, <code>false</code> if it should be done by this
         *                LayoutManager.
         * @see #isAutoMeasureEnabled()
         ...
         * true if a LayoutManager wants to be auto measured by the ARecyclerView.
         * <p>
         * If this method is overridden to return true,
         * {@link LayoutManager#onMeasure(Recycler, State, int, int)} should not be overridden.
         * <p>
         * AutoMeasure is a ARecyclerView mechanism that handles the measuring pass of layout in a
         ...
         * {@link ARecyclerView#onMeasure(int, int)}, and then calculating desired dimensions based
         * on children's dimensions and positions. It does this while supporting all existing
         * animation capabilities of the ARecyclerView.
         * <p>
         * More specifically:
         * <ol>
         * <li>When {@link ARecyclerView#onMeasure(int, int)} is called, if the provided measure
         * specs both have a mode of {@link View.MeasureSpec#EXACTLY}, ARecyclerView will set its
         * measured dimensions accordingly and return, allowing layout to continue as normal
         * (Actually, ARecyclerView will call
         ...
         * <li>If one of the layout specs is not {@code EXACT}, the ARecyclerView will start the
         ...
         * return the width and height of the ARecyclerView as of the last layout calculation.
         * <p>
         * After handling the predictive case, ARecyclerView will call
         ...
         * <li>After the layout calculation, ARecyclerView sets the measured width & height by
         * calculating the bounding box for the children (+ ARecyclerView's padding). The
         ...
         * <li>Any following calls to {@link ARecyclerView#onMeasure(int, int)} will run
         * {@link #onLayoutChildren(Recycler, State)} with {@link State#isMeasuring()} set to
         * {@code true} and {@link State#isPreLayout()} set to {@code false}. ARecyclerView will
         ...
         * <li>When measure is complete and ARecyclerView's
         * {@link #onLayout(boolean, int, int, int, int)} method is called, ARecyclerView checks
         ...
         * mechanism of {@link ARecyclerView} or <code>False</code> if it should be done by the
         ...
         * <p>
         * Whether item animations actually occur in a ARecyclerView is actually determined by both
         * the return value from this method and the
         * {@link ARecyclerView#setItemAnimator(ItemAnimator) ItemAnimator} set on the
         * ARecyclerView itself. If the ARecyclerView has a non-null ItemAnimator but this
         * method returns false, then only "simple item animations" will be enabled in the
         * ARecyclerView, in which views whose position are changing are simply faded in/out. If the
         * ARecyclerView has a non-null ItemAnimator and this method returns true, then predictive
         * item animations will be enabled in the ARecyclerView.
         *
         ...
         * @param state                  State of ARecyclerView
         ...
         * ARecyclerView to come on screen, due to the movement of another, containing ARecyclerView.
         *
         * <p>This method is only called when a ARecyclerView is nested in another ARecyclerView.</p>
         *
        ...
        void dispatchAttachedToWindow(ARecyclerView view) {
            mIsAttachedToWindow = true;
            onAttachedToWindow(view);
        }

        void dispatchDetachedFromWindow(ARecyclerView view, Recycler recycler) {
            mIsAttachedToWindow = false;
            onDetachedFromWindow(view, recycler);
        }

        /**
         * Returns whether LayoutManager is currently attached to a ARecyclerView which is attached
         * to a window.
         *
         * @return True if this LayoutManager is controlling a ARecyclerView and the ARecyclerView
         ...
         * <p>
         * Calling this method when LayoutManager is not attached to a ARecyclerView has no effect.
         *
         ...
         * @return true if ARecyclerView could ask the Handler to remove the Runnable,
        ...
        /**
         * Called when this LayoutManager is both attached to a ARecyclerView and that ARecyclerView
         * is attached to a window.
         * <p>
         * If the ARecyclerView is re-attached with the same LayoutManager and Adapter, it may not
         * call {@link #onLayoutChildren(Recycler, State)} if nothing has changed and a layout was
         * not requested on the ARecyclerView while it was detached.
         * <p>
         * Subclass implementations should always call through to the superclass implementation.
         *
         * @param view The ARecyclerView this LayoutManager is bound to
         * @see #onDetachedFromWindow(ARecyclerView, Recycler)
         */
        @CallSuper
        public void onAttachedToWindow(ARecyclerView view) {
        }

        /**
         * @deprecated override {@link #onDetachedFromWindow(ARecyclerView, Recycler)}
         */
        @Deprecated
        public void onDetachedFromWindow(ARecyclerView view) {

        }

        /**
         * Called when this LayoutManager is detached from its parent ARecyclerView or when
         * its parent ARecyclerView is detached from its window.
         * <p>
         * LayoutManager should clear all of its View references as another LayoutManager might be
         * assigned to the ARecyclerView.
         * <p>
         * If the ARecyclerView is re-attached with the same LayoutManager and Adapter, it may not
         * call {@link #onLayoutChildren(Recycler, State)} if nothing has changed and a layout was
         * not requested on the ARecyclerView while it was detached.
         ...
         * call {@link ARecyclerView#requestLayout()} to ensure that it is re-laid out when
         * ARecyclerView is re-attached.
         * <p>
         * Subclass implementations should always call through to the superclass implementation.
         *
         * @param view     The ARecyclerView this LayoutManager is bound to
         ...
         *                 keeping them around.
         * @see #onAttachedToWindow(ARecyclerView)
         */
        @CallSuper
        @SuppressLint("UnknownNullness") // b/240775049: Cannot annotate properly
        public void onDetachedFromWindow(ARecyclerView view, Recycler recycler) {
            onDetachedFromWindow(view);
        }

        /**
         * Check if the ARecyclerView is configured to clip child views to its padding.
         *
         * @return true if this ARecyclerView clips children to its padding, false otherwise
         */
        public boolean getClipToPadding() {
         ...
         * ARecyclerView has a non-null {@link #getItemAnimator() ItemAnimator}, and simple
         ...
         * ARecyclerView will have enough information to run those animations in a simple
         ...
         * appropriately, without regard to the actual bounds of the ARecyclerView. This allows
         * the animation system to know the location to which to animate these disappearing
         * views.</p>
         *
         * <p>The default LayoutManager implementations for ARecyclerView handle all of these
         * requirements for animations already. Clients of ARecyclerView can either use one
         ...
         *                 position
         * @param state    Transient state of ARecyclerView
         */
        @SuppressLint("UnknownNullness") // b/240775049: Cannot annotate properly
        ...
        /**
         * Create a default <code>LayoutParams</code> object for a child of the ARecyclerView.
         *
         * <p>LayoutManagers will often want to use a custom <code>LayoutParams</code> type
         * to store extra information specific to the layout. Client code should subclass
         * {@link ARecyclerView.LayoutParams} for this purpose.</p>
         *
         ...
         * </p>
         *
         * @param recyclerView The ARecyclerView to which this layout manager is attached
         * @param state        Current State of ARecyclerView
         * @param position     Scroll to this adapter position.
         */
        @SuppressLint("UnknownNullness") // b/240775049: Cannot annotate properly
        public void smoothScrollToPosition(ARecyclerView recyclerView, State state,
                                           int position) {
        ...
        /**
         * @return true if ARecyclerView is currently in the state of smooth scrolling.
         */
        ...
        /**
         * Returns the resolved layout direction for this ARecyclerView.
         *
         ...
         * @see ARecyclerView.ItemAnimator#endAnimations()
         */
        @SuppressLint("UnknownNullness") // b/240775049: Cannot annotate properly
         ...
         * visible portion of the container but is being laid out in order to inform ARecyclerView
        ...
        /**
         * Add a view to the currently attached ARecyclerView if needed. LayoutManagers should
        ...
        private void addViewInt(View child, int index, boolean disappearing) {
            ...
            if (holder.wasReturnedFromScrap() || holder.isScrap()) {
                ...
                if (currentIndex == -1) {
                    throw new IllegalStateException("Added View has ARecyclerView as parent but"
        ...
        /**
         * Remove a view from the currently attached ARecyclerView if needed. LayoutManagers should
        ...
        /**
         * Remove all views from the currently attached ARecyclerView. This will not recycle
        ...
        /**
         * Returns offset of the ARecyclerView's text baseline from the its top boundary.
         *
         * @return The offset of the ARecyclerView's text baseline from the its top boundary; -1 if
        ...
        public int getPosition(@NonNull View view) {
            return ((ARecyclerView.LayoutParams) view.getLayoutParams()).getViewLayoutPosition();
        }
         ...
         * <p>
         * Note that this method may return null if the view is a child of the ARecyclerView but
         ...
         * @see ARecyclerView#getChildViewHolder(View)
         * @see ARecyclerView#findContainingViewHolder(View)
         */
        @Nullable
        public View findContainingItemView(@NonNull View view) {
            if (mRecyclerView == null) {
         ...
         * views currently attached to the ARecyclerView. Generally LayoutManager implementations
         * will want to use {@link #detachAndScrapView(android.view.View, ARecyclerView.Recycler)}
         ...
         * {@link #attachView(android.view.View, int, ARecyclerView.LayoutParams) reattach}
         * or {@link #removeDetachedView(android.view.View) fully remove} the detached view
         * before the LayoutManager entry point method called by ARecyclerView returns.</p>
         *
         ...
         * {@link #detachAndScrapView(android.view.View, ARecyclerView.Recycler)}  scrapped}.
         *
        ...
        /**
         * Return the current number of child views attached to the parent ARecyclerView.
         ...
         *
         * <p>When ARecyclerView is running a layout, this value is always set to
         ...
         *
         * <p>This value is usually equal to the laid out width of the {@link ARecyclerView} but may
         * reflect the current {@link android.view.View.MeasureSpec} width if the
         * {@link LayoutManager} is using AutoMeasure and the ARecyclerView is in the process of
         ...
         *
         * <p>This value is usually equal to the laid out height of the {@link ARecyclerView} but may
        ...
        /**
         * Return the left padding of the parent ARecyclerView
         *
        ...
        /**
         * Return the top padding of the parent ARecyclerView
         *
         * @return Padding in pixels
         */
        @Px
        ...
        /**
         * Return the right padding of the parent ARecyclerView
         *
         * @return Padding in pixels
         */
        @Px
        ...
        /**
         * Return the bottom padding of the parent ARecyclerView
         *
         * @return Padding in pixels
         */
        @Px
        ...
        /**
         * Return the start padding of the parent ARecyclerView
         *
         * @return Padding in pixels
         */
        @Px
        ...
        /**
         * Return the end padding of the parent ARecyclerView
         *
         * @return Padding in pixels
         */
        @Px
        ...
        /**
         * Returns true if the ARecyclerView this LayoutManager is bound to has focus.
         *
         * @return True if the ARecyclerView has focus, false otherwise.
         * @see View#isFocused()
         */
        ...
        /**
         * Returns true if the ARecyclerView this LayoutManager is bound to has or contains focus.
         *
         * @return true if the ARecyclerView has or contains focus
         * @see View#hasFocus()
         */
         ...
         *
         * @return A direct child of ARecyclerView which has focus or contains the focused child.
         */
        @Nullable
        ...
        /**
         * Returns the number of items in the adapter bound to the parent ARecyclerView.
         * <p>
        ...
        /**
         * Offset all child views attached to the parent ARecyclerView by dx pixels along
         * the horizontal axis.
         *
        ...
        /**
         * Offset all child views attached to the parent ARecyclerView by dy pixels along
         * the vertical axis.
         *
         ...
         * call remove and invalidate ARecyclerView to ensure UI update.
         *
         ...
         * of the parent ARecyclerView and any added item decorations into account.
         *
         * <p>If the ARecyclerView can be scrolled in either dimension the caller may
        ...
        /**
         * ARecyclerView internally does its own View measurement caching which should help with
         * WRAP_CONTENT.
         * <p>
        ...
        /**
         * In addition to the View Framework's measurement cache, ARecyclerView uses its own
        ...
        /**
         * Sets whether ARecyclerView should use its own measurement cache for the children. This is
        ...
        /**
         * Measure a child view using standard measurement policy, taking the padding
         * of the parent ARecyclerView, any added item decorations and the child margins
         * into account.
         *
         * <p>If the ARecyclerView can be scrolled in either dimension the caller may
         * pass 0 as the widthUsed or heightUsed parameters as they will be irrelevant.</p>
         ...
         * @param canScroll      true if the parent ARecyclerView can scroll in this dimension
        ...
        /**
         * Lay out the given child view within the ARecyclerView using coordinates that
         ...
         * (translation, scale etc) with respect to the ARecyclerView.
         * <p>
         ...
         */
        public void getDecoratedBoundsWithMargins(@NonNull View view, @NonNull Rect outBounds) {
            ARecyclerView.getDecoratedBoundsWithMarginsInt(view, outBounds);
        }
         ...
         * for the current content of the ARecyclerView.
         *
         ...
         * then {@link #onFocusSearchFailed(View, int, ARecyclerView.Recycler, ARecyclerView.State)}
         ...
         * the padded area of ARecyclerView.
         *
        ...
        /**
         * Called when a child of the ARecyclerView wants a particular rectangle to be positioned
         ...
         * to bring the given rect into view, within the padded area of the ARecyclerView.</p>
         *
         * @param child     The direct child making the request.
         * @param rect      The rectangle in the child's coordinates the child
         *                  wishes to be on the screen.
         ...
         */
        public boolean requestChildRectangleOnScreen(@NonNull ARecyclerView parent,
                                                     @NonNull View child, @NonNull Rect rect, boolean immediate) {
            return requestChildRectangleOnScreen(parent, child, rect, immediate, false);
        }

        /**
         * Requests that the given child of the ARecyclerView be positioned onto the screen. This
         ...
         *
         * @param parent              The parent ARecyclerView.
         * @param child               The direct child making the request.
         * @param rect                The rectangle in the child's coordinates the child
         *                            wishes to be on the screen.
         * @param immediate           True to forbid animated or delayed scrolling,
         ...
         * bounded area of ARecyclerView, depending on the input parameters.
         ...
         */
        private boolean isFocusedChildVisibleAfterScrolling(ARecyclerView parent, int dx, int dy) {
        ...
        /**
         * @deprecated Use {@link #onRequestChildFocus(ARecyclerView, State, View, View)}
         */
        @Deprecated
        public boolean onRequestChildFocus(@NonNull ARecyclerView parent, @NonNull View child,
        ...
        /**
         * Called when a descendant view of the ARecyclerView requests focus.
         *
         ...
         *
         * @param parent  The ARecyclerView hosting this LayoutManager
         * @param state   Current state of ARecyclerView
         * @param child   Direct child of the ARecyclerView containing the newly focused view
         ...
         */
        public boolean onRequestChildFocus(@NonNull ARecyclerView parent, @NonNull State state,
                                           @NonNull View child, @Nullable View focused) {
            return onRequestChildFocus(parent, child, focused);
        }

        /**
         * Called if the ARecyclerView this LayoutManager is bound to has a different adapter set via
         * {@link ARecyclerView#setAdapter(Adapter)} or
         * {@link ARecyclerView#swapAdapter(Adapter, boolean)}. The LayoutManager may use this
         ...
         *                   {@link ARecyclerView#setAdapter(ARecyclerView.Adapter)} is called with
         *                   {@code null}.
         */
        ...
        /**
         * Called to populate focusable views within the ARecyclerView.
         *
         ...
         * suppressed.</p>
         *
         * <p>The default implementation returns <code>false</code> to trigger ARecyclerView
         * to fall back to the default ViewGroup behavior.</p>
         *
         * @param recyclerView  The ARecyclerView hosting this LayoutManager
         ...
         */
        public boolean onAddFocusables(@NonNull ARecyclerView recyclerView,
         ...
         * {@link ARecyclerView#swapAdapter(Adapter, boolean)} ()} and signals that the the entire
         * data set has changed.
         */
        public void onItemsChanged(@NonNull ARecyclerView recyclerView) {
        }
         ...
         */
        public void onItemsAdded(@NonNull ARecyclerView recyclerView, int positionStart,
                                 int itemCount) {
        }
         ...
         */
        public void onItemsRemoved(@NonNull ARecyclerView recyclerView, int positionStart,
                                   int itemCount) {
        }

        /**
         * Called when items have been changed in the adapter.
         * To receive payload,  override {@link #onItemsUpdated(ARecyclerView, int, int, Object)}
         * instead, then this callback will not be invoked.
         */
        public void onItemsUpdated(@NonNull ARecyclerView recyclerView, int positionStart,
                                   int itemCount) {
        }

        /**
         * Called when items have been changed in the adapter and with optional payload.
         * Default implementation calls {@link #onItemsUpdated(ARecyclerView, int, int)}.
         */
        public void onItemsUpdated(@NonNull ARecyclerView recyclerView, int positionStart,
         ...
         * is called.
         */
        public void onItemsMoved(@NonNull ARecyclerView recyclerView, int from, int to,
                                 int itemCount) {
         ...
         *
         * <p>Read {@link ARecyclerView#computeHorizontalScrollExtent()} for details.</p>
         *
         * <p>Default implementation returns 0.</p>
         *
         * @param state Current state of ARecyclerView
         * @return The horizontal extent of the scrollbar's thumb
         * @see ARecyclerView#computeHorizontalScrollExtent()
         */
         ...
         * <p>Override this method if you want to support scroll bars.</p>
         *
         * <p>Read {@link ARecyclerView#computeHorizontalScrollOffset()} for details.</p>
         *
         * <p>Default implementation returns 0.</p>
         *
         * @param state Current State of ARecyclerView where you can find total item count
         * @return The horizontal offset of the scrollbar's thumb
         * @see ARecyclerView#computeHorizontalScrollOffset()
         */
         ...
         * <p>Override this method if you want to support scroll bars.</p>
         *
         * <p>Read {@link ARecyclerView#computeHorizontalScrollRange()} for details.</p>
         *
         * <p>Default implementation returns 0.</p>
         *
         * @param state Current State of ARecyclerView where you can find total item count
         * @return The total horizontal range represented by the vertical scrollbar
         * @see ARecyclerView#computeHorizontalScrollRange()
         */
         ...
         * <p>Override this method if you want to support scroll bars.</p>
         *
         * <p>Read {@link ARecyclerView#computeVerticalScrollExtent()} for details.</p>
         *
         * <p>Default implementation returns 0.</p>
         *
         * @param state Current state of ARecyclerView
         * @return The vertical extent of the scrollbar's thumb
         * @see ARecyclerView#computeVerticalScrollExtent()
         */
         ...
         * <p>Override this method if you want to support scroll bars.</p>
         *
         * <p>Read {@link ARecyclerView#computeVerticalScrollOffset()} for details.</p>
         *
         * <p>Default implementation returns 0.</p>
         *
         * @param state Current State of ARecyclerView where you can find total item count
         * @return The vertical offset of the scrollbar's thumb
         * @see ARecyclerView#computeVerticalScrollOffset()
         */
         ...
         * <p>Override this method if you want to support scroll bars.</p>
         *
         * <p>Read {@link ARecyclerView#computeVerticalScrollRange()} for details.</p>
         *
         * <p>Default implementation returns 0.</p>
         *
         * @param state Current State of ARecyclerView where you can find total item count
         * @return The total vertical range represented by the vertical scrollbar
         * @see ARecyclerView#computeVerticalScrollRange()
         */
        ...
        /**
         * Measure the attached ARecyclerView. Implementations must call
         ...
         * measure cases including when the ARecyclerView's layout_width or layout_height have been
         ...
         * the minimum width and height properties of the host ARecyclerView if measured
         * as UNSPECIFIED. AT_MOST measurements will be treated as EXACTLY and the ARecyclerView
        ...
        /**
         * @return The host ARecyclerView's {@link View#getMinimumWidth()}
         */
        @Px
        ...
        /**
         * @return The host ARecyclerView's {@link View#getMinimumHeight()}
         */
        @Px
         ...
         * <p>ARecyclerView does NOT verify if the LayoutManager has changed between state save and
        ...
        /**
         * Called when the ARecyclerView is ready to restore the state based on a previous
         * ARecyclerView.
         * <p>
        ...
        /**
         * ARecyclerView calls this method to notify LayoutManager that scroll state has changed.
         *
         * @param state The new scroll state for ARecyclerView
         */
        public void onScrollStateChanged(int state) {
        }
         ...
         * <p>
         * You should override
         * {@link #getRowCountForAccessibility(ARecyclerView.Recycler, ARecyclerView.State)},
         * {@link #getColumnCountForAccessibility(ARecyclerView.Recycler, ARecyclerView.State)},
         * {@link #isLayoutHierarchical(ARecyclerView.Recycler, ARecyclerView.State)} and
         * {@link #getSelectionModeForAccessibility(ARecyclerView.Recycler, ARecyclerView.State)} for
         ...
         *                 positions
         * @param state    The current state of ARecyclerView
         * @param info     The info that should be filled by the LayoutManager
         * @see View#onInitializeAccessibilityNodeInfo(
         *android.view.accessibility.AccessibilityNodeInfo)
         * @see #getRowCountForAccessibility(ARecyclerView.Recycler, ARecyclerView.State)
         * @see #getColumnCountForAccessibility(ARecyclerView.Recycler, ARecyclerView.State)
         * @see #isLayoutHierarchical(ARecyclerView.Recycler, ARecyclerView.State)
         * @see #getSelectionModeForAccessibility(ARecyclerView.Recycler, ARecyclerView.State)
         */
        ...
        /**
         * A LayoutManager can call this method to force ARecyclerView to run simple animations in
         * the next layout pass, even if there is not any trigger to do so. (e.g. adapter data
         * change).
         * <p>
         * Note that, calling this method will not guarantee that ARecyclerView will run animations
         * at all. For example, if there is not any {@link ItemAnimator} set, ARecyclerView will
        ...
        /**
         * Called by AccessibilityDelegate when an action is requested from the ARecyclerView.
         *
         * @param recycler The Recycler that can be used to convert view positions into adapter
         *                 positions
         * @param state    The current state of ARecyclerView
        ...
        public static Properties getProperties(@NonNull Context context,
            ...
            properties.orientation = a.getInt(R.styleable.ARecyclerView_android_orientation,
                    DEFAULT_ORIENTATION);
            properties.spanCount = a.getInt(R.styleable.ARecyclerView_spanCount, 1);
            properties.reverseLayout = a.getBoolean(R.styleable.ARecyclerView_reverseLayout, false);
            properties.stackFromEnd = a.getBoolean(R.styleable.ARecyclerView_stackFromEnd, false);
            a.recycle();
            return properties;
        }

        void setExactMeasureSpecsFrom(ARecyclerView recyclerView) {
            setMeasureSpecs(
     ...
     * views (in {@link ItemDecoration#onDraw(Canvas, ARecyclerView, ARecyclerView.State) onDraw()}
     * and after the items (in {@link ItemDecoration#onDrawOver(Canvas, ARecyclerView,
     * ARecyclerView.State)}.</p>
     */
    public abstract static class ItemDecoration {
        /**
         * Draw any appropriate decorations into the Canvas supplied to the ARecyclerView.
         * Any content drawn by this method will be drawn before the item views are drawn,
         * and will thus appear underneath the views.
         *
         * @param c      Canvas to draw into
         * @param parent ARecyclerView this ItemDecoration is drawing into
         * @param state  The current state of ARecyclerView
         */
        public void onDraw(@NonNull Canvas c, @NonNull ARecyclerView parent, @NonNull State state) {
            onDraw(c, parent);
        }

        /**
         * @deprecated Override {@link #onDraw(Canvas, ARecyclerView, ARecyclerView.State)}
         */
        @Deprecated
        public void onDraw(@NonNull Canvas c, @NonNull ARecyclerView parent) {
        }
         ...
         * @param state  The current state of ARecyclerView.
         */
        public void onDrawOver(@NonNull Canvas c, @NonNull ARecyclerView parent,
                               @NonNull State state) {
            onDrawOver(c, parent);
        }

        /**
         * @deprecated Override {@link #onDrawOver(Canvas, ARecyclerView, ARecyclerView.State)}
         */
        @Deprecated
        public void onDrawOver(@NonNull Canvas c, @NonNull ARecyclerView parent) {
        }
        ...
        /**
         * @deprecated Use {@link #getItemOffsets(Rect, View, ARecyclerView, State)}
         */
        @Deprecated
        public void getItemOffsets(@NonNull Rect outRect, int itemPosition,
                                   @NonNull ARecyclerView parent) {
            outRect.set(0, 0, 0, 0);
        }
         ...
         * {@link ARecyclerView#getChildAdapterPosition(View)} to get the adapter position of the
         * View.
         *
         * @param outRect Rect to receive the output.
         * @param view    The child view to decorate
         * @param parent  ARecyclerView this ItemDecoration is decorating
         * @param state   The current state of ARecyclerView.
         */
        public void getItemOffsets(@NonNull Rect outRect, @NonNull View view,
                                   @NonNull ARecyclerView parent, @NonNull State state) {
     ...
     * view hierarchy level of the ARecyclerView before those touch events are considered for
     * ARecyclerView's own scrolling behavior.
     *
     * <p>This can be useful for applications that wish to implement various forms of gestural
     * manipulation of item views within the ARecyclerView. OnItemTouchListeners may intercept
     * a touch interaction already in progress even if the ARecyclerView is already handling that
    ...
    public interface OnItemTouchListener {
        /**
         * Silently observe and/or take over touch events sent to the ARecyclerView
         * before they are handled by either the ARecyclerView itself or its child views.
         *
         * <p>The onInterceptTouchEvent methods of each attached OnItemTouchListener will be run
         * in the order in which each listener was added, before any other touch processing
         * by the ARecyclerView itself or child views occurs.</p>
         *
         * @param e MotionEvent describing the touch event. All coordinates are in
         *          the ARecyclerView's coordinate system.
         * @return true if this OnItemTouchListener wishes to begin intercepting touch events, false
         * to continue with the current behavior and continue observing future events in
         * the gesture.
         */
        boolean onInterceptTouchEvent(@NonNull ARecyclerView rv, @NonNull MotionEvent e);
         ...
         *          the ARecyclerView's coordinate system.
         */
        void onTouchEvent(@NonNull ARecyclerView rv, @NonNull MotionEvent e);

        /**
         * Called when a child of ARecyclerView does not want ARecyclerView and its ancestors to
    ...
    /**
     * An implementation of {@link ARecyclerView.OnItemTouchListener} that has empty method bodies
     ...
     */
    public static class SimpleOnItemTouchListener implements ARecyclerView.OnItemTouchListener {
        @Override
        public boolean onInterceptTouchEvent(@NonNull ARecyclerView rv, @NonNull MotionEvent e) {
            return false;
        }

        @Override
        public void onTouchEvent(@NonNull ARecyclerView rv, @NonNull MotionEvent e) {
        }
    ...
    /**
     * An OnScrollListener can be added to a ARecyclerView to receive messages when a scrolling event
     * has occurred on that ARecyclerView.
     * <p>
     *
     * @see ARecyclerView#addOnScrollListener(OnScrollListener)
     * @see ARecyclerView#clearOnChildAttachStateChangeListeners()
     */
    public abstract static class OnScrollListener {
        /**
         * Callback method to be invoked when ARecyclerView's scroll state changes.
         *
         * @param recyclerView The ARecyclerView whose scroll state has changed.
         * @param newState     The updated scroll state. One of {@link #SCROLL_STATE_IDLE},
         *                     {@link #SCROLL_STATE_DRAGGING} or {@link #SCROLL_STATE_SETTLING}.
         */
        public void onScrollStateChanged(@NonNull ARecyclerView recyclerView, int newState) {
        }

        /**
         * Callback method to be invoked when the ARecyclerView has been scrolled. This will be
         * called after the scroll has completed.
         * <p>
         * This callback will also be called if visible item range changes after a layout
         * calculation. In that case, dx and dy will be 0.
         *
         * @param recyclerView The ARecyclerView which scrolled.
    ...
    /**
     * A RecyclerListener can be set on a ARecyclerView to receive messages whenever
     * a view is recycled.
     *
     * @see ARecyclerView#setRecyclerListener(RecyclerListener)
     */
     ...
     * whenever a ViewHolder is attached to or detached from ARecyclerView.
     */
    public interface OnChildAttachStateChangeListener {

        /**
         * Called when a view is attached to the ARecyclerView.
         *
         * @param view The View which is attached to the ARecyclerView
         */
        void onChildViewAttachedToWindow(@NonNull View view);

        /**
         * Called when a view is detached from ARecyclerView.
         *
         * @param view The View which is being detached from the ARecyclerView
         */
        void onChildViewDetachedFromWindow(@NonNull View view);
    }

    /**
     * A ViewHolder describes an item view and metadata about its place within the ARecyclerView.
     *
     ...
     * to <code>ViewHolder</code> objects and that <code>ARecyclerView</code> instances may hold
    ...
    public abstract static class ViewHolder {
         ...
         * the end of the layout pass and then recycled by ARecyclerView if it is not added back to
         * the ARecyclerView.
         */
         ...
         * {@link RecycledViewPool}.
         */
        ARecyclerView mOwnerRecyclerView;
         ...
         * <p>
         * This position is mostly used by ARecyclerView components to be consistent while
         * ARecyclerView lazily processes adapter updates.
         * <p>
         * For performance and animation reasons, ARecyclerView batches all adapter updates until the
         ...
         * positions. All methods in {@link ARecyclerView.LayoutManager}, {@link ARecyclerView.State},
         * {@link ARecyclerView.Recycler} that receive a position expect it to be the layout position
         * of the item.
         * <p>
         * If LayoutManager needs to call an external method that requires the adapter position of
         * the item, it can use {@link #getAbsoluteAdapterPosition()} or
         * {@link ARecyclerView.Recycler#convertPreLayoutPositionToPostLayout(int)}.
         *
         ...
         * {@link #getBindingAdapterPosition()} or if you want the position as {@link ARecyclerView}
         ...
         * <p>
         * ARecyclerView does not handle any adapter updates until the next layout traversal. This
         ...
         * <p>
         * Note that if you've called {@link ARecyclerView.Adapter#notifyDataSetChanged()}, until the
         ...
         * {@link ARecyclerView} considers (e.g. for saved state), you should use
         * {@link #getAbsoluteAdapterPosition()}.
         *
         * @return The adapter position of the item if it still exists in the adapter.
         * {@link ARecyclerView#NO_POSITION} if item has been removed from the adapter,
         * {@link ARecyclerView.Adapter#notifyDataSetChanged()} has been called after the last
        ...
        /**
         * Returns the Adapter position of the item represented by this ViewHolder with respect to
         * the {@link ARecyclerView}'s {@link Adapter}. If the {@link Adapter} that bound this
         ...
         * next layout pass, the return value of this method will be {@link #NO_POSITION}.
         * <p>
         * Note that if you are querying the position as {@link ARecyclerView} sees, you should use
         ...
         *
         * @return The adapter position of the item from {@link ARecyclerView}'s perspective if it
        ...
        /**
         * When LayoutManager supports animations, ARecyclerView tracks 3 positions for ViewHolders
         ...
         *
         * @return The item's id if adapter has stable ids, {@link ARecyclerView#NO_ID}
         * otherwise
         */
         ...
         */
        void onEnteredHiddenState(ARecyclerView parent) {
         ...
         */
        void onLeftHiddenState(ARecyclerView parent) {
            parent.setChildImportantForAccessibilityInternal(this,
                    mWasImportantForAccessibilityBeforeHidden);
            mWasImportantForAccessibilityBeforeHidden = ViewCompat.IMPORTANT_FOR_ACCESSIBILITY_AUTO;
        }
        ...
        /**
         * @return True if ViewHolder is not referenced by ARecyclerView animations but has
    ...
    int getAdapterPositionInRecyclerView(ViewHolder viewHolder) {
        if (viewHolder.hasAnyOfTheFlags(ViewHolder.FLAG_INVALID
                ...
                || !viewHolder.isBound()) {
            return ARecyclerView.NO_POSITION;
        }
     ...
     * {@link ARecyclerView}. Custom {@link LayoutManager layout managers} are encouraged
    ...
    public static class LayoutParams extends android.view.ViewGroup.MarginLayoutParams {
         ...
         * {@link ARecyclerView} sees, use {@link #getAbsoluteAdapterPosition()}.
         */
        @Deprecated
         ...
         * corresponds to in the {@link ARecyclerView}. If the {@link ARecyclerView} has an
         * {@link Adapter} that merges other adapters, this position will be with respect to the
         * adapter that is assigned to the {@link ARecyclerView}.
         *
         * @return the up-to-date adapter position this view with respect to the ARecyclerView. It
         * may return {@link ARecyclerView#NO_POSITION} if item represented by this View has been
         * removed or
         ...
         * bound this View. It may return {@link ARecyclerView#NO_POSITION} if item represented by
    ...
    public abstract static class SmoothScroller {
        ...
        private int mTargetPosition = ARecyclerView.NO_POSITION;
         ...
         * <p>In each animation step, {@link ARecyclerView} will check
         * for the target view and call either
         * {@link #onTargetFound(android.view.View, ARecyclerView.State, SmoothScroller.Action)} or
         * {@link #onSeekTargetStep(int, int, ARecyclerView.State, SmoothScroller.Action)} until
         * SmoothScroller is stopped.</p>
         *
         * <p>Note that if ARecyclerView finds the target view, it will automatically stop the
         ...
         */
        void start(ARecyclerView recyclerView, LayoutManager layoutManager) {
            ...
            if (mTargetPosition == ARecyclerView.NO_POSITION) {
         ...
         * {@link #onTargetFound(android.view.View, ARecyclerView.State, SmoothScroller.Action)} or
         * {@link #onSeekTargetStep(int, int, ARecyclerView.State, SmoothScroller.Action)}.
         */
        protected final void stop() {
            ...
            mRunning = false;
            onStop();
            mRecyclerView.mState.mTargetPosition = ARecyclerView.NO_POSITION;
            mTargetView = null;
            mTargetPosition = ARecyclerView.NO_POSITION;
         ...
         * {@link ARecyclerView#NO_POSITION} if no target view is set.
         */
        ...
        void onAnimation(int dx, int dy) {
            final ARecyclerView recyclerView = mRecyclerView;
            if (mTargetPosition == ARecyclerView.NO_POSITION || recyclerView == null) {
                stop();
            }
        ...
        /**
         * @see ARecyclerView#getChildLayoutPosition(android.view.View)
         */
        ...
        /**
         * @see ARecyclerView.LayoutManager#getChildCount()
         */
        public int getChildCount() {
        ...
        /**
         * @see ARecyclerView.LayoutManager#findViewByPosition(int)
         */
        public View findViewByPosition(int position) {
        ...
        /**
         * @see ARecyclerView#scrollToPosition(int)
        ...
        /**
         * <p>ARecyclerView will call this method each time it scrolls until it can find the target
        ...
        public static class Action {
            ...
            public static final int UNDEFINED_DURATION = ARecyclerView.UNDEFINED_DURATION;
             ...
             * {@link ARecyclerView#scrollToPosition(int)}.
             * <p>
            ...
            void runIfNecessary(ARecyclerView recyclerView) {
        ...
        /**
         * An interface which is optionally implemented by custom {@link ARecyclerView.LayoutManager}
    ...
    /**
     * <p>Contains useful information about the current ARecyclerView state like target scroll
     * position or view focus. State object can also keep arbitrary data, identified by resource
     * ids.</p>
     * <p>Often times, ARecyclerView components will need to pass information between each other.
     * To provide a well defined data bus between components, ARecyclerView passes the same State
    ...
    public static class State {
        ...
        int mTargetPosition = ARecyclerView.NO_POSITION;
        ...
        /**
         * True if the associated {@link ARecyclerView} is in the pre-layout step where it is having
        ...
        /**
         * Prepare for a prefetch occurring on the ARecyclerView in between traversals, potentially
        ...
        /**
         * Returns true if the ARecyclerView is currently measuring the layout. This value is
         * {@code true} only if the LayoutManager opted into the auto measure API and ARecyclerView
         * has non-exact measurement specs.
         * <p>
         * Note that if the LayoutManager supports predictive animations and it is calculating the
         * pre-layout step, this value will be {@code false} even if the ARecyclerView is in
         * {@code onMeasure} call. This is because pre-layout means the previous state of the
         * ARecyclerView and measurements made for that state cannot change the ARecyclerView's size.
         ...
         *
         * @return True if the ARecyclerView is currently calculating its bounds, false otherwise.
         */
        ...
        /**
         * Returns true if the {@link ARecyclerView} is in the pre-layout step where it is having its
        ...
        /**
         * Returns whether ARecyclerView will run predictive animations in this layout pass
         * or not.
         *
         * @return true if ARecyclerView is calculating predictive animations to be run at the end
         * of the layout pass.
         */
        ...
        /**
         * Returns whether ARecyclerView will run simple animations in this layout pass
         * or not.
         *
         * @return true if ARecyclerView is calculating simple animations to be run at the end of
         * the layout pass.
         */
         ...
         * {@link ARecyclerView#NO_POSITION} if there is no target
         * position.
         */
        ...
        public boolean hasTargetScrollPosition() {
            return mTargetPosition != ARecyclerView.NO_POSITION;
        }
         ...
         * <p>
         * ARecyclerView listens for Adapter's notify events and calculates the effects of adapter
         * data changes on existing Views. These calculations are used to decide which animations
         * should be run.
         * <p>
         * To support predictive animations, ARecyclerView may rewrite or reorder Adapter changes to
         ...
         * scenes, ARecyclerView offsets {@link Recycler#getViewForPosition(int)} calls such that
     ...
     * ViewHolder items. The ARecyclerView will manage retaining these items while they
     ...
     *
     * <p>By default, ARecyclerView uses {@link DefaultItemAnimator}.</p>
     *
    ...
    public abstract static class ItemAnimator {
        ...
        /**
         * Called by the ARecyclerView before the layout begins. Item animator should record
         ...
         *
         * @param state       The current State of ARecyclerView which includes some useful data
        ...
        /**
         * Called by the ARecyclerView after the layout is complete. Item animator should record
         ...
         * the View.
         *
         * @param state      The current State of ARecyclerView which includes some useful data about
         ...
         * ARecyclerView decides how items should be animated.
         * @see #recordPreLayoutInformation(State, ViewHolder, int, List)
         * @see #animateAppearance(ViewHolder, ItemHolderInfo, ItemHolderInfo)
         * @see #animateDisappearance(ViewHolder, ItemHolderInfo, ItemHolderInfo)
         * @see #animateChange(ViewHolder, ViewHolder, ItemHolderInfo, ItemHolderInfo)
        ...
        /**
         * Called by the ARecyclerView when a ViewHolder has disappeared from the layout.
         * <p>
         ...
         * animation callback method which will be called by the ARecyclerView depends on the
         ...
         * ViewHolder or not. ARecyclerView will call
         * {@link #animateChange(ViewHolder, ViewHolder, ItemHolderInfo, ItemHolderInfo)
         ...
         * ARecyclerView will call {@link #recordPostLayoutInformation(State, ViewHolder)} and the
        ...
        /**
         * Called by the ARecyclerView when a ViewHolder is added to the layout.
         * <p>
        ...
        /**
         * Called by the ARecyclerView when a ViewHolder is present in both before and after the
         * layout and ARecyclerView has not received a {@link Adapter#notifyItemChanged(int)} call
         ...
         * <p>
         * If the Item's layout position didn't change, ARecyclerView still calls this method because
        ...
        /**
         * Called by the ARecyclerView when an adapter item is present both before and after the
         * layout and ARecyclerView has received a {@link Adapter#notifyItemChanged(int)} call
         * for it. This method may also be called when
         * {@link Adapter#notifyDataSetChanged()} is called and adapter has stable ids so that
         * ARecyclerView could still rebind views to the same ViewHolders. If viewType changes when
         ...
         * <p>
         * When an item is updated, ItemAnimator has a chance to ask ARecyclerView to keep the
         ...
         * to the LayoutManager but ARecyclerView keeps old ViewHolder attached for animations.
         * <p>
         ...
         * {@link #animateDisappearance(ViewHolder, ItemHolderInfo, ItemHolderInfo)
         * animateDisappearance()}, which inform the ARecyclerView that the ItemAnimator wants to be
         ...
         * <p>
         * For each call ARecyclerView makes to
         * {@link #animateAppearance(ViewHolder, ItemHolderInfo, ItemHolderInfo)
         * animateAppearance()},
         * {@link #animatePersistence(ViewHolder, ItemHolderInfo, ItemHolderInfo)
         ...
         * the same ViewHolder for animations or ARecyclerView should create a copy of the
         ...
         * @return True if ARecyclerView should just rebind to the same ViewHolder or false if
         * ARecyclerView should create a new ViewHolder and pass this ViewHolder to the
         ...
         *                   {@link ARecyclerView.Adapter#notifyDataSetChanged()}. The same list of
         *                   payloads will be passed into
         *                   {@link ARecyclerView.Adapter#onBindViewHolder(ViewHolder, int, List)}
         ...
         * {@link #recordPreLayoutInformation(ARecyclerView.State, ViewHolder, int, List)} and
         * {@link #recordPostLayoutInformation(ARecyclerView.State, ViewHolder)} returns this data
        ...
        public static class ItemHolderInfo {
            ...
            /**
             * The change flags that were passed to
             * {@link #recordPreLayoutInformation(ARecyclerView.State, ViewHolder, int, List)}.
             */
            @AdapterChanges
             ...
             */
            @NonNull
            public ItemHolderInfo setFrom(@NonNull ARecyclerView.ViewHolder holder) {
             ...
             *               {@link #recordPreLayoutInformation(ARecyclerView.State, ViewHolder, int,
             *               List)}.
             * @return This {@link ItemHolderInfo}
             */
            @NonNull
    ...
    /**
     * A callback interface that can be used to alter the drawing order of ARecyclerView children.
     * <p>
    ...
    public interface ChildDrawingOrderCallback {
         ...
         * @see ARecyclerView#setChildDrawingOrderCallback(ARecyclerView.ChildDrawingOrderCallback)
         */
