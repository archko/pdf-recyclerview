...
/**
 * The AccessibilityDelegate used by ARecyclerView.
 * <p>
 * This class handles basic accessibility actions and delegates them to LayoutManager.
 */
public class RecyclerViewAccessibilityDelegate extends AccessibilityDelegateCompat {
    final ARecyclerView mRecyclerView;
    private final ItemDelegate mItemDelegate;


    public RecyclerViewAccessibilityDelegate(@NonNull ARecyclerView recyclerView) {
    ...
    public void onInitializeAccessibilityEvent(View host, AccessibilityEvent event) {
        ...
        if (host instanceof ARecyclerView && !shouldIgnore()) {
            ARecyclerView rv = (ARecyclerView) host;
    ...
    /**
     * Gets the AccessibilityDelegate for an individual item in the ARecyclerView.
    ...
    public static class ItemDelegate extends AccessibilityDelegateCompat {
         ...
         *
         * @param recyclerViewDelegate The parent ARecyclerView's accessibility delegate.
         */
