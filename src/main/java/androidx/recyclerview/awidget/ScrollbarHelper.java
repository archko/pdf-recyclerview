...
class ScrollbarHelper {
     ...
     */
    static int computeScrollOffset(ARecyclerView.State state, OrientationHelper orientation,
                                   View startChild, View endChild, ARecyclerView.LayoutManager lm,
     ...
     * @param endChild   View closest to end of the list (bottom or right)
     */
    static int computeScrollExtent(ARecyclerView.State state, OrientationHelper orientation,
                                   View startChild, View endChild, ARecyclerView.LayoutManager lm,
     ...
     * @param endChild   View closest to end of the list (bottom or right)
     */
    static int computeScrollRange(ARecyclerView.State state, OrientationHelper orientation,
                                  View startChild, View endChild, ARecyclerView.LayoutManager lm,
                                  boolean smoothScrollbarEnabled) {
        if (lm.getChildCount() == 0 || state.getItemCount() == 0 || startChild == null
                || endChild == null) {
