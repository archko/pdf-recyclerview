...
/**
 * {@link ARecyclerView.SmoothScroller} implementation which uses a {@link LinearInterpolator} until
 * the target position becomes a child of the ARecyclerView and then uses a
 * {@link DecelerateInterpolator} to slowly approach to target position.
 * <p>
 * If the {@link ARecyclerView.LayoutManager} you are using does not implement the
 ...
 */
public class LinearSmoothScroller extends ARecyclerView.SmoothScroller {
     ...
     * <p>For instance, if the view is virtually on the left of ARecyclerView, using
     ...
     */
    @Override
    protected void onTargetFound(View targetView, ARecyclerView.State state, Action action) {
     ...
     */
    @Override
    protected void onSeekTargetStep(int dx, int dy, ARecyclerView.State state, Action action) {
     ...
     * or the right edge of the child with the parent ARecyclerView.
     *
     ...
     * or the bottom edge of the child with the parent ARecyclerView.
     *
     * @return SNAP_TO_START, SNAP_TO_END or SNAP_TO_ANY; depending on the current target vector
     * @see #SNAP_TO_START
     * @see #SNAP_TO_END
    ...
    /**
     * When the target scroll position is not a child of the ARecyclerView, this method calculates
    ...
    public int calculateDyToMakeVisible(View view, int snapPreference) {
        final ARecyclerView.LayoutManager layoutManager = getLayoutManager();
