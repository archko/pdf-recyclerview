...
public class GridLayoutManager extends LinearLayoutManager {
     ...
     */
    public GridLayoutManager(Context context, int spanCount,
                             @ARecyclerView.Orientation int orientation, boolean reverseLayout) {
    ...
    @Override
    public int getRowCountForAccessibility(ARecyclerView.Recycler recycler,
    ...
    @Override
    public int getColumnCountForAccessibility(ARecyclerView.Recycler recycler,
                                              ARecyclerView.State state) {
    ...
    @Override
    public void onInitializeAccessibilityNodeInfoForItem(ARecyclerView.Recycler recycler,
                                                         ARecyclerView.State state, View host, AccessibilityNodeInfoCompat info) {
    ...
    @Override
    public void onInitializeAccessibilityNodeInfo(@NonNull ARecyclerView.Recycler recycler,
                                                  @NonNull ARecyclerView.State state, @NonNull AccessibilityNodeInfoCompat info) {
    ...
    @Override
    public void onItemsAdded(ARecyclerView recyclerView, int positionStart, int itemCount) {
        mSpanSizeLookup.invalidateSpanIndexCache();
        mSpanSizeLookup.invalidateSpanGroupIndexCache();
    }

    @Override
    public void onItemsChanged(ARecyclerView recyclerView) {
        mSpanSizeLookup.invalidateSpanIndexCache();
        mSpanSizeLookup.invalidateSpanGroupIndexCache();
    }

    @Override
    public void onItemsRemoved(ARecyclerView recyclerView, int positionStart, int itemCount) {
        mSpanSizeLookup.invalidateSpanIndexCache();
        mSpanSizeLookup.invalidateSpanGroupIndexCache();
    }

    @Override
    public void onItemsUpdated(ARecyclerView recyclerView, int positionStart, int itemCount,
                               Object payload) {
        mSpanSizeLookup.invalidateSpanIndexCache();
        mSpanSizeLookup.invalidateSpanGroupIndexCache();
    }
    ...
    @Override
    public void onItemsMoved(ARecyclerView recyclerView, int from, int to, int itemCount) {
        mSpanSizeLookup.invalidateSpanIndexCache();
        mSpanSizeLookup.invalidateSpanGroupIndexCache();
    }
    ...
    @Override
    public ARecyclerView.LayoutParams generateLayoutParams(Context c, AttributeSet attrs) {
        return new LayoutParams(c, attrs);
    }

    @Override
    public ARecyclerView.LayoutParams generateLayoutParams(ViewGroup.LayoutParams lp) {
    ...
    @Override
    public boolean checkLayoutParams(ARecyclerView.LayoutParams lp) {
    ...
    private void ensureAnchorIsInCorrectSpan(ARecyclerView.Recycler recycler,
                                             ARecyclerView.State state, AnchorInfo anchorInfo, int itemDirection) {
    ...
    private int getSpanGroupIndex(ARecyclerView.Recycler recycler, ARecyclerView.State state,
                                  int viewPosition) {
        if (!state.isPreLayout()) {
    ...
    private int getSpanIndex(ARecyclerView.Recycler recycler, ARecyclerView.State state, int pos) {
        if (!state.isPreLayout()) {
    ...
    private int getSpanSize(ARecyclerView.Recycler recycler, ARecyclerView.State state, int pos) {
        if (!state.isPreLayout()) {
    ...
    private void assignSpans(ARecyclerView.Recycler recycler, ARecyclerView.State state, int count,
    ...
    private int computeScrollRangeWithSpanInfo(ARecyclerView.State state) {
    ...
    private int computeScrollOffsetWithSpanInfo(ARecyclerView.State state) {
        if (getChildCount() == 0 || state.getItemCount() == 0) {
            return 0;
        }
        ensureLayoutState();
     ...
     */
    public static class LayoutParams extends ARecyclerView.LayoutParams {
        ...
        public LayoutParams(ARecyclerView.LayoutParams source) {
            super(source);
        }
