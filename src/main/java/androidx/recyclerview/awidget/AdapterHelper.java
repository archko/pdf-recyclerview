 ...
 * <p>
 * To support animations, ARecyclerView presents an older version the Adapter to best represent
 * previous state of the layout. Sometimes, this is not trivial when items are removed that were
 * not laid out, in which case, ARecyclerView has no way of providing that item's view for
 * animations.
 * <p>
...
class AdapterHelper implements OpReorderer.Callback {
    ...
    private void applyRemove(UpdateOp op) {
        ...
        for (int position = op.positionStart; position < tmpEnd; position++) {
            ...
            ARecyclerView.ViewHolder vh = mCallback.findViewHolder(position);
    ...
    /**
     * Contract between AdapterHelper and ARecyclerView.
     */
    interface Callback {

        ARecyclerView.ViewHolder findViewHolder(int position);
