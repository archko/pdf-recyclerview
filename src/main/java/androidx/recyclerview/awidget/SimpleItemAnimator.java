 ...
 */
public abstract class SimpleItemAnimator extends ARecyclerView.ItemAnimator {
     ...
     * {@link #animateChange(ARecyclerView.ViewHolder, ARecyclerView.ViewHolder, int, int, int, int)} implementation.
     ...
     *                                 {@link #animateChange(ARecyclerView.ViewHolder, ARecyclerView.ViewHolder, int, int, int,
     *                                 int)} when changes occur.
     * @see ARecyclerView.Adapter#notifyItemChanged(int)
     * @see ARecyclerView.Adapter#notifyItemRangeChanged(int, int)
     */
     ...
     */
    @Override
    public boolean canReuseUpdatedViewHolder(@NonNull ARecyclerView.ViewHolder viewHolder) {
        return !mSupportsChangeAnimations || viewHolder.isInvalid();
    }

    @Override
    public boolean animateDisappearance(@NonNull ARecyclerView.ViewHolder viewHolder,
    ...
    @Override
    public boolean animateAppearance(@NonNull ARecyclerView.ViewHolder viewHolder,
    ...
    @Override
    public boolean animatePersistence(@NonNull ARecyclerView.ViewHolder viewHolder,
    ...
    @Override
    public boolean animateChange(@NonNull ARecyclerView.ViewHolder oldHolder, @NonNull ARecyclerView.ViewHolder newHolder,
                                 @NonNull ItemHolderInfo preLayoutInfo, @NonNull ItemHolderInfo postLayoutInfo) {
        if (DEBUG) {
    ...
    /**
     * Called when an item is removed from the ARecyclerView. Implementors can choose
     * whether and how to animate that change, but must always call
     * {@link #dispatchRemoveFinished(ARecyclerView.ViewHolder)} when done, either
     * immediately (if no animation will occur) or after the animation actually finishes.
     * The return value indicates whether an animation has been set up and whether the
     * ItemAnimator's {@link #runPendingAnimations()} method should be called at the
     * next opportunity. This mechanism allows ItemAnimator to set up individual animations
     * as separate calls to {@link #animateAdd(ARecyclerView.ViewHolder) animateAdd()},
     * {@link #animateMove(ARecyclerView.ViewHolder, int, int, int, int) animateMove()},
     * {@link #animateRemove(ARecyclerView.ViewHolder) animateRemove()}, and
     * {@link #animateChange(ARecyclerView.ViewHolder, ARecyclerView.ViewHolder, int, int, int, int)} come in one by one,
     ...
     * ARecyclerView, but for which the system does not have enough information to animate
     ...
     * false otherwise.
     */
    public abstract boolean animateRemove(ARecyclerView.ViewHolder holder);

    /**
     * Called when an item is added to the ARecyclerView. Implementors can choose
     * whether and how to animate that change, but must always call
     * {@link #dispatchAddFinished(ARecyclerView.ViewHolder)} when done, either
     * immediately (if no animation will occur) or after the animation actually finishes.
     * The return value indicates whether an animation has been set up and whether the
     * ItemAnimator's {@link #runPendingAnimations()} method should be called at the
     * next opportunity. This mechanism allows ItemAnimator to set up individual animations
     ...
     * false otherwise.
     */
    public abstract boolean animateAdd(ARecyclerView.ViewHolder holder);

    /**
     * Called when an item is moved in the ARecyclerView. Implementors can choose
     * whether and how to animate that change, but must always call
     * {@link #dispatchMoveFinished(ARecyclerView.ViewHolder)} when done, either
     * immediately (if no animation will occur) or after the animation actually finishes.
     * The return value indicates whether an animation has been set up and whether the
     * ItemAnimator's {@link #runPendingAnimations()} method should be called at the
     * next opportunity. This mechanism allows ItemAnimator to set up individual animations
     ...
     * false otherwise.
     */
    public abstract boolean animateMove(ARecyclerView.ViewHolder holder, int fromX, int fromY,
                                        int toX, int toY);

    /**
     * Called when an item is changed in the ARecyclerView, as indicated by a call to
     * {@link ARecyclerView.Adapter#notifyItemChanged(int)} or
     * {@link ARecyclerView.Adapter#notifyItemRangeChanged(int, int)}.
     * <p>
     * Implementers can choose whether and how to animate changes, but must always call
     * {@link #dispatchChangeFinished(ARecyclerView.ViewHolder, boolean)} for each non-null distinct ViewHolder,
     ...
     * {@link #dispatchChangeFinished(ARecyclerView.ViewHolder, boolean)} once and only once. In that case, the
     ...
     * false otherwise.
     */
    public abstract boolean animateChange(ARecyclerView.ViewHolder oldHolder,
                                          ARecyclerView.ViewHolder newHolder, int fromLeft, int fromTop, int toLeft, int toTop);

    /**
     * Method to be called by subclasses when a remove animation is done.
     *
     * @param item The item which has been removed
     * @see ARecyclerView.ItemAnimator#animateDisappearance(ARecyclerView.ViewHolder, ItemHolderInfo,
     * ItemHolderInfo)
     */
    public final void dispatchRemoveFinished(ARecyclerView.ViewHolder item) {
     ...
     * @see ARecyclerView.ItemAnimator#animateDisappearance(ARecyclerView.ViewHolder, ItemHolderInfo,
     * ItemHolderInfo)
     * @see ARecyclerView.ItemAnimator#animatePersistence(ARecyclerView.ViewHolder, ItemHolderInfo, ItemHolderInfo)
     * @see ARecyclerView.ItemAnimator#animateAppearance(ARecyclerView.ViewHolder, ItemHolderInfo, ItemHolderInfo)
     */
    public final void dispatchMoveFinished(ARecyclerView.ViewHolder item) {
        onMoveFinished(item);
        dispatchAnimationFinished(item);
    }
     ...
     */
    public final void dispatchAddFinished(ARecyclerView.ViewHolder item) {
        onAddFinished(item);
        dispatchAnimationFinished(item);
    }
     ...
     *                {@link #animateChange(ARecyclerView.ViewHolder, ARecyclerView.ViewHolder, int, int, int, int)}).
     * @param oldItem true if this is the old item that was changed, false if
     *                it is the new item that replaced the old item.
     * @see #animateChange(ARecyclerView.ViewHolder, ARecyclerView.ViewHolder, int, int, int, int)
     */
    public final void dispatchChangeFinished(ARecyclerView.ViewHolder item, boolean oldItem) {
     ...
     */
    public final void dispatchRemoveStarting(ARecyclerView.ViewHolder item) {
     ...
     */
    public final void dispatchMoveStarting(ARecyclerView.ViewHolder item) {
        onMoveStarting(item);
    }
     ...
     */
    public final void dispatchAddStarting(ARecyclerView.ViewHolder item) {
        onAddStarting(item);
    }
     ...
     *                it is the new item that replaced the old item.
     */
    public final void dispatchChangeStarting(ARecyclerView.ViewHolder item, boolean oldItem) {
    ...
    public void onRemoveStarting(ARecyclerView.ViewHolder item) {
    }
     ...
     * @param item The ViewHolder being animated.
     */
    public void onRemoveFinished(ARecyclerView.ViewHolder item) {
    }
     ...
     */
    @SuppressWarnings("UnusedParameters")
    public void onAddStarting(ARecyclerView.ViewHolder item) {
    }
     ...
     * @param item The ViewHolder being animated.
     */
    public void onAddFinished(ARecyclerView.ViewHolder item) {
    }
     ...
     */
    @SuppressWarnings("UnusedParameters")
    public void onMoveStarting(ARecyclerView.ViewHolder item) {
    }
     ...
     * @param item The ViewHolder being animated.
     */
    public void onMoveFinished(ARecyclerView.ViewHolder item) {
    }
     ...
     */
    @SuppressWarnings("UnusedParameters")
    public void onChangeStarting(ARecyclerView.ViewHolder item, boolean oldItem) {
    }
     ...
     *                it is the new item that replaced the old item.
     */
    public void onChangeFinished(ARecyclerView.ViewHolder item, boolean oldItem) {
    }
}
